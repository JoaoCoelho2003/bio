    ...
    <div class="container mx-auto px-4 py-12">
      <div class="relative z-10 max-w-6xl mx-auto">
        <div class="text-center mb-12">
          <h1 class="text-4xl font-bold text-green-500 mb-4 glitch-text" data-text="Technical Arsenal">
            <EncryptingText text="Technical Arsenal" />
          </h1>
          <p class="text-gray-400 max-w-2xl mx-auto">
            An overview of my technical capabilities and expertise across various domains
        ...
        <div class="grid md:grid-cols-3 gap-8 mt-12">
          <div v-for="(category, index) in categories" 
            ...
            <ul class="space-y-2">
              <li v-for="(tech, idx) in category.technologies" 
                  :key="idx"
...
const categories = ref([
  ...
  {
    title: 'DevOps & Tools',
    description: 'Implementing and maintaining development operations and tooling.',
    technologies: [
      'Git', 
      'Docker'
    ]
