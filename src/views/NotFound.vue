    ...
    <div class="min-h-screen bg-black pt-16">
      ...
      <div class="container mx-auto px-4 py-12">
        <div class="relative z-10 max-w-4xl mx-auto text-center">
          <h1 class="text-8xl font-bold text-green-500 mb-4 glitch-text" data-text="404">
            <EncryptingText text="404" />
          </h1>
          <p class="text-2xl text-gray-400 mb-8 glitch-text-subtle" data-text="System Malfunction: Page Not Found">
